...
<script>
    ...
    function print_receipt() {
        ...
        setTimeout(() => {
            ...
            var nw = window.open(_base_url_ + "cashier/sales/print_receipt.php?id=<?php echo $_GET['id'] ?>", '_blank', "width=" + ($(window).width() * .2) + ",left=" + ($(window).width() * .3) + ",height=" + ($(window).height() * .8) + ",top=" + ($(window).height() * .1))
            setTimeout(() => {
                nw.print()
                setTimeout(() => {
                    nw.close()
    ...
    function complete_order() {
        window.location.replace(_base_url_ + "cashier/?page=sales/manage_sale&s=complete")
