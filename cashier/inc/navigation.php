...
<aside class="main-sidebar sidebar-light-warning navbar-light elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?php echo base_url ?>cashier" class="brand-link bg-warning text-sm">
          ...
          <nav class="mt-1">
            <ul
              ...
              <?php if ($_settings->userdata('type') == 1): ?>
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>cashier/?page=user/list" class="nav-link nav-user_list">
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>cashier/?page=system_info" class="nav-link nav-system_info">
