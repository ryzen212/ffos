    ...
    <div class="col order-item">
        <div class="card rounded-0 shadow card-outline">
            ...
            <div class="card-footer py-1 text-center">
                <button class="btn btn-sm text-light  border order-served px-2 btn-block" type="button"
                    data-id="">Serve</button>
            </div>
        </div>
    </div>
</noscript>
                ...
                if (resp.status == 'success') {
                    ...
                    Object.keys(resp.data).map(k => {
                        ...
                        if (data.status == 3) {
                            ...
                            card.find('.order-served').text('Served')
                            process = 'Serve';
                        ...
                        if (data.status == 4) {
                            ...
                            card.find('.order-served').text('Collect')
                            // card.find('.order-served').remove()
                   
                            process = 'Collect';
                            card.find('.order-served').removeClass("prebtn").addClass("serbtn");
                        ...
                        Object.keys(data.item_arr).map(i => {
                            ...
                            row.find('div').last().text('₱' + data.item_arr[i].price)
