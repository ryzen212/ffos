		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" required
				...
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="phone" id="phone" required
						value="<?php echo $_settings->info('phone') ?>">
				</div>
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="mobile" id="mobile" required
						value="<?php echo $_settings->info('mobile') ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="name" class="control-label">TIN Number</label>
					<input type="text" class="form-control form-control-sm" name="tin" id="tin" required
						value="<?php echo $_settings->info('tin') ?>">
				</div>
				<div class="form-group">
					<label for="name" class="control-label">Address</label>
					<input type="text" class="form-control form-control-sm" name="address" id="address" required
						value="<?php echo $_settings->info('address') ?>">
				</div>
