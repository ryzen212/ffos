...
<div class="row">
  <div class="col-12 col-sm-4 col-md-4">
    <a href="./?page=categories" class="link-danger" style='color:black;'>
      <div class="info-box">
  ...
  <!-- /.col -->
  <div class="col-12 col-sm-4 col-md-4">
    <a href="./?page=menus" class="link-danger" style='color:black;'>
      <div class="info-box">
      ...
      <a href="./?page=reports" class="link-danger" style='color:black;'>
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number text-right h5">
              <?php
              $orders = $conn->query("SELECT coalesce(SUM(total_amount),0) FROM order_list where status = 1 and date(`date_created`) = '" . (date('Y-m-d')) . "'")->fetch_array()[0];
    ...
    <div class="col-12 col-sm-4 col-md-4">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number text-right h5">
            <?php
            $orders = $conn->query("SELECT coalesce(SUM(total_amount),0) FROM order_list where date(`date_created`) = '" . (date('Y-m-d')) . "' and status = 1 and user_id = '{$_settings->userdata('id')}'")->fetch_array()[0];
            $orders = $orders > 0 ? $orders : 0;
            echo format_num($orders, 2);
            ?>
            <?php ?>
