...
<!-- <script type="text/javascript" src="<?php echo base_url ?>plugins/chartjs/chart.umd.min.js"></script>

<script  src="<?php echo base_url ?>plugins/chartjs/chartjs-adapter-date-fns.bundle.min.js"></script> -->
